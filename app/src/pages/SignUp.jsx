      ...
      <div className="flex-1 flex items-center justify-center p-4 md:p-8">
        ...
        <div className="hidden md:flex w-full max-w-5xl rounded-3xl shadow-cozy bg-surface-container-lowest overflow-hidden min-h-150">
          ...
          <div className="w-1/2 p-12 flex flex-col justify-center">
            ...
            <p className="mt-2 text-on-surface-variant text-sm">
              Create an account to host & taste artisan snacks.
            </p>

            <form onSubmit={handleSubmit} className="mt-6 space-y-4">
              <Field label="Name" type="text" value={name} onChange={setName} placeholder="Your full name" required />
              <Field label="Email" type="email" value={email} onChange={setEmail} placeholder="hello@snackshare.com" required />
              ...
              <label className="flex items-start gap-3 text-xs text-on-surface-variant cursor-pointer">
                ...
                />
                <span>
                  I agree to the <span className="text-primary font-bold">Terms</span> &{" "}
        ...
        <div className="md:hidden w-full max-w-md flex flex-col px-2 py-4">
          ...
          <h1 className="mt-6 font-headline text-3xl font-extrabold text-primary leading-tight">
            Start your<br />Artisanal Journey.
          </h1>
          <p className="mt-3 text-on-surface-variant text-sm">
            A few details to join the sanctuary.
          </p>

          <form onSubmit={handleSubmit} className="mt-8 space-y-5">
            <UpperField label="NAME" type="text" value={name} onChange={setName} placeholder="Your name" />
            <UpperField label="EMAIL" type="email" value={email} onChange={setEmail} placeholder="you@example.com" />
            <UpperField label="PASSWORD" type="password" value={password} onChange={setPassword} placeholder="At least 6 characters" />
            <UpperField label="CONFIRM PASSWORD" type="password" value={confirm} onChange={setConfirm} placeholder="Repeat password" />
          ...
          <div className="mt-8 rounded-2xl bg-secondary-container p-5 shadow-cozy">
            ...
            <h3 className="mt-1 font-headline text-lg font-extrabold text-on-secondary-container leading-tight">
              Get curated artisan snacks every Sunday.
            </h3>
            <p className="mt-2 text-xs text-on-secondary-container/80">
              Members unlock exclusive small-batch tastings.
            </p>
          </div>
        </div>
      </div>
