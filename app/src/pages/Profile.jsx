...
import { Star, MapPin, CalendarDays, Settings, LogOut } from "lucide-react";
          ...
          <div className="flex gap-12 mb-10">
            ...
            <div className="text-center">
              <div className="flex items-center justify-center gap-1">
                ...
                <span className="text-4xl font-extrabold text-white">{user.rating}</span>
              </div>
          ...
          <div className="flex gap-8">
            ...
            <div className="text-center">
              <div className="flex items-center gap-0.5 justify-center">
                ...
                <span className="text-xl font-extrabold text-white">{user.rating}</span>
              </div>
